...
The following visualisations provide a compact comparison of path quality, smoothness, runtime, and reliability. In the Pareto-style plot, lower ranks are better and bubble area represents median execution time on a logarithmic scale. Methods with no valid path are stated explicitly rather than omitted.

<p align="center">
  <img src="assets/benchmark_quality_tradeoffs.png" alt="Path-quality rank trade-offs across the three benchmark maps" width="1000">
</p>

<p align="center"><em>Path-quality trade-offs across the three maps. Bubble labels report valid runs out of five.</em></p>

<p align="center">
  <img src="assets/dense_map_performance_heatmap.png" alt="Performance-rank heatmap for the dense-obstacle map" width="670">
</p>

<p align="center"><em>Dense-obstacle map: within-map ranks summarise path length, turning angle, execution time, clearance, and successful runs.</em></p>
